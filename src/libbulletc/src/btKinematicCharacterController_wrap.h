...
extern "C"
{
	EXPORT btKinematicCharacterController* btKinematicCharacterController_new(btPairCachingGhostObject* ghostObject, btConvexShape* convexShape, btScalar stepHeight, btScalar* up);
	...
	//EXPORT btVector3 btKinematicCharacterController_getGravity(btKinematicCharacterController* obj);
